/*************************************************************************
*   Transform commands from labrom_mav_common to Pelican ROS format (Header file)
...
#ifndef LABROM_MAV_INTERFACE_PELICAN_H_
#define LABROM_MAV_INTERFACE_PELICAN_H_
...
class Pelican{
  ...
  private:
    ...
    ros::Publisher m_mav_ctrl_pub;              //!< CmdVel Publisher
