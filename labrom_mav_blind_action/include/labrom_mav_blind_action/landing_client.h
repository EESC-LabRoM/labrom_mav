...
class Client{
  public:
    ...
    void DoneCallback(const actionlib::SimpleClientGoalState& state, const labrom_mav_blind_action::LandingResult::ConstPtr& result);
    //! Feedback
    void FeedbackCallback(const labrom_mav_blind_action::LandingFeedback::ConstPtr& feedback);
    //! Cancel all goals
  ...
  private:
    ...
    actionlib::SimpleActionClient<labrom_mav_blind_action::LandingAction> ac_;       //! Actionlib client
};
} // take_off namespace 
} // blind namespace
