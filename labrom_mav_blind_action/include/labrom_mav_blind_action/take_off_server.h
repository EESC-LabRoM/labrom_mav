...
class Server{
  public:
    ...
    //! Goal Callback
    void GoalCallback(const labrom_mav_blind_action::TakeOffGoalConstPtr &goal);
    //! Preemption Callback
  ...
  private:
    ...
    actionlib::SimpleActionServer<labrom_mav_blind_action::TakeOffAction> as_;          //!< Action server
     // Take off blind messages defined within actionlib
    labrom_mav_blind_action::TakeOffFeedback feedback_;  //!< Feedback message
    labrom_mav_blind_action::TakeOffResult result_;      //!< Result message
    labrom_mav_blind_action::TakeOffGoal goal_;          //!< Goal message
