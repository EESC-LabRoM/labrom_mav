...
class Client{
  public:
    ...
    void DoneCallback(const actionlib::SimpleClientGoalState& state, const labrom_mav_manager::TakeOffResult::ConstPtr& result);
    //! Feedback
    void FeedbackCallback(const labrom_mav_manager::TakeOffFeedback::ConstPtr& feedback);
    //! Cancel all goals
  ...
  private:
    ...
    actionlib::SimpleActionClient<labrom_mav_manager::TakeOffAction> ac_;       //! Actionlib client
};
} // take_off namespace 
} // blind namespace
