...
class Server{
  public:
    ...
    //! Goal Callback
    void GoalCallback(const labrom_mav_manager::LandingGoalConstPtr &goal);
    //! Preemption Callback
  ...
  private:
    ...
    actionlib::SimpleActionServer<labrom_mav_manager::LandingAction> as_;          //!< Action server
     // Landing blind messages defined within actionlib
    labrom_mav_manager::LandingFeedback feedback_;  //!< Feedback message
    labrom_mav_manager::LandingResult result_;      //!< Result message
    labrom_mav_manager::LandingGoal goal_;          //!< Goal message
